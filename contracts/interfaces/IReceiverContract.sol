 ...
 * @notice In the overriding functions, the customer has to repay the loan with the fee(determined by governanace)
 * or else, the entire transaction will revert to the initial state.
 */
